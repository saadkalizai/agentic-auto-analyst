...
"## ??? Project Structure" 
"\`\`\`" 
"agentic-auto-analyst/" 
"ÃÄÄ agents/           # AI Agents" 
"³   ÃÄÄ planner.py    # Task decomposition" 
"³   ÃÄÄ researcher.py # Web search & analysis" 
"³   ÃÄÄ critic.py     # Validation & critique" 
"³   ÀÄÄ base_llm.py   # LLM wrapper" 
"ÃÄÄ demo/             # Mock data system" 
"ÃÄÄ outputs/          # Analysis results" 
"ÃÄÄ app.py            # Main orchestrator" 
"ÃÄÄ streamlit_app.py  # Web interface" 
...
"## ??? Tech Stack" 
"- **Framework**: LangChain" 
"- **LLM**: Groq + LLaMA 3 / Mistral (Free Tier)" 
